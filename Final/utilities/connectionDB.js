...
//function to find the connectionID given the topic and name of a connection
...
var deleteConnection = async function(connectionID){
    var result='';
    await connections.deleteOne({connectionID: connectionID}, function(err, res){ //update the change in db
        if(err) return handleError(err);
        console.log('Connection deleted from the db.');
